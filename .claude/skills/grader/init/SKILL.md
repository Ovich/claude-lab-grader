...
## Grading Procedure
<!-- AI-generated, professor-approved. Status tag is always the first content line.  -->
<!-- status: DRAFT → procedure generated, pending professor review and approval.      -->
<!-- status: READY → professor explicitly approved; grader/grade may proceed.         -->
<!-- Never change DRAFT to READY without explicit professor confirmation.              -->
...
## Run Plan
<!-- Generated by grader/procedure when live criteria exist.         -->
<!-- AI-run: approved = AI starts the project, professor tests.      -->
<!-- AI-run: opted-out = professor runs everything independently.    -->
